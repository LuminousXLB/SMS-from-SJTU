...
function deserialize_ReceiveMessageRequest(buffer_arg) {
  return sms_pb.ReceiveMessageRequest.deserializeBinary(
...
function deserialize_ReceiveMessageResponse(buffer_arg) {
  return sms_pb.ReceiveMessageResponse.deserializeBinary(
    new Uint8Array(buffer_arg)
  )
}
...
function deserialize_SendMessageResponse(buffer_arg) {
  return sms_pb.SendMessageResponse.deserializeBinary(
    new Uint8Array(buffer_arg)
  )
}
...
export var SmsClient = grpc.makeGenericClientConstructor(SmsService)
